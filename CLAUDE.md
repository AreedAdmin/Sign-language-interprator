...
**Demo format:** Pre-recorded video — the signer performs a scripted 25-sign sequence and the system outputs each phrase from `asl_words.txt` in order.
...
**Performance targets:** N/A — demo is pre-recorded. Prioritise correctness and clean output over speed.
...
- **No live demo risk** — the presentation uses a pre-recorded video; re-record if a take is imperfect.
